...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    conv_1d = Conv1D(filters, kernel_size, 
                     ...
                     activation='relu',
                     name='conv1d')(input_data)
    bn1 = BatchNormalization(name='bn_conv_1')(conv_1d)
    max_1d = MaxPooling1D(pool_size=kernel_size, strides=1, padding='same', name='maxpool_1d')(bn1)
    bn2 = BatchNormalization(name='bn_conv_2')(max_1d)
    bidir_rnn = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn'))(bn2)
    bn3 = BatchNormalization(name='bn_rnn')(bidir_rnn)
